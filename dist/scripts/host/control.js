...
(function (WesterOS) {
    var Control = (function () {
        ...
        Control.displayReadyQueue = function () {
            ...
            if (_CurrentProcess && _CurrentProcess.state !== "TERMINATED") {
                activeProcesses[_CurrentProcess.pcb.pid] = _CurrentProcess;
            }
        ...
        Control.displayHardDrive = function () {
            ...
            for (var track = 0; track < _FileSystem.tracks; track++) {
                for (var sector = 0; sector < _FileSystem.sectors; sector++) {
                    for (var block = 0; block < _FileSystem.blocks; block++) {
                        ...
                        output += '<tr><td>' + key + '</td>' + '<td>' + data.substring(0, 4) + '</td>' + '<td>' + data.substring(4) + '</td></tr>';
                    }
                }
            }
