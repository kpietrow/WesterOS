...
//
var APP_NAME: string    = "Viper-OS";   // 'cause Bob and I were at a loss for a better name.
...
// Global Variables
//
var _CPU: Viper.Cpu;  // Utilize TypeScript's type annotation system to ensure that _CPU is an instance of the Cpu class.
